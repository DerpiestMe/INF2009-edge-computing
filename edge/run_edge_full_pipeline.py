...
class FullEdgePipelineApp:
    ...
    def __init__(
        ...
        approach_on_detect: bool = True,
        approach_close_bbox_height_px: int = 400,
        ...
        teleop_speed_x: float = 4.0,
        teleop_yaw_deg_s: float = 10.0,
        teleop_hold_timeout_s: float = 0.18,
        gait_mode: str = "walk",
        body_height: float = -8.0,
        snapshot_cooldown_seconds: float = 5.0,
        wrist_servo_id: int = 10,
        wrist_start_pulse: int = 750,
